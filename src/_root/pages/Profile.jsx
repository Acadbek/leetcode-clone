          ...
          <div className="border p-3 rounded-lg">
            ...
            <div className="mt-3 flex flex-col gap-2">
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="#1E3A8A" fillRule="evenodd" d="M1 12c2.028-4.152 6.192-7 11-7s8.972 2.848 11 7c-2.028 4.152-6.192 7-11 7s-8.972-2.848-11-7m11 3.5a3.5 3.5 0 1 0 0-7a3.5 3.5 0 0 0 0 7" /></svg>
        ...
        <div className="col-span-9">
          ...
          <Tabs defaultValue="recent" className="w-full mt-4">
            ...
            <TabsContent value="recent">
              <div
                className="flex flex-col [&>a]:border-l [&>a]:border-r [&>*:first-child]:border-t [&>*:first-child]:rounded-t-lg [&>*:last-child]:border-b [&>*:last-child]:border-l [&>*:last-child]:border-r [&>*:last-child]:rounded-b-lg dark:[&>*:nth-child(odd)]:bg-zinc-800 [&>*:nth-child(odd)]:bg-zinc-100">
